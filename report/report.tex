...
\begin{table*}[t!]
  \begin{tabular}{l|lllllllllllll}
    ...
    \\ \hline
    $Z$ & -379.0 & 496.4 & 6523.0 & 1171385 & 1055.2 & 3565.8 & 4603.5 & 1410.6 &
    -867.2 & 2599.0 & 1292.9 & 1387.3 & 40285.5 \\
  ...
  \caption{Motif significance $Z$ compared to a random network and normalized
    mutual information score for motif clustering with each of the 13 motifs.}
  \label{tab:motifs}
\end{table*}
